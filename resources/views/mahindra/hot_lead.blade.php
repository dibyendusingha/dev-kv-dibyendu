    ...
    <div class="pagetitle">
        ...
        <nav class="d-flex justify-content-between w-100">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Contacted Leads</li>
            </ol>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{url('mahindra-hot-filter')}}" method="post">
                            @csrf
                                ...
                                <div class="w-25">
                                    ...
                                    <button type="submit" class="d-flex align-items-center submit-btn" style="margin-top: 30px"><i class="bi bi-funnel me-2"></i>FILTER</button>
