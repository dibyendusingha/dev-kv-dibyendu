...
?>
    ...
    <section class="post-category bg-t" id="pc">
        <div class="container glass-t">
            ...
            <img src="./assets/images/fert-head.png" alt="" width="100">
                <h3><?php if (session()->has('bn')) {echo $lang['bn']['FERTILIZERS'];} 
...
<div class="form-content container">
    <form action="{{url('fertilizer-posting')}}" method="post" class="form" enctype="multipart/form-data">
        @csrf
        <!-- Progress bar -->
        ...
        <div class="form-step form-step-active animate__animated animate__zoomIn enDetails">
            ...
            <div class="container tractor-brand" id="msform1">
                ...
                <textarea name="description" id="description" cols="20" rows="10" placeholder="Description" class="" ></textarea>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="img-trac-box fw-bold">
                                        ...
                                        <img id="preview-s1" class="img-fluid"
                                                src="./assets/images/ferti-cat.png" alt="">
