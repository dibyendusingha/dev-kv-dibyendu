...
?>
    ...
    <section class="post-category bg-t" id="pc">
        <div class="container glass-t">
            ...
            <img src="./assets/images/sprayer.png" alt="" width="100">
                <h3><?php if (session()->has('bn')) {echo $lang['bn']['PESTICIDES'];} 
...
<div class="form-content container">
    <form action="{{url('pesticide-posting')}}" method="post" class="form" enctype="multipart/form-data">
        @csrf
        <!-- Progress bar -->
                ...
                <div class="row">
                    ...
                    <div class="img-trac-box fw-bold">
                                        ...
                                        <img id="preview-s1" class="img-fluid"
                                                src="./assets/images/pesticide-img.png" alt="">
