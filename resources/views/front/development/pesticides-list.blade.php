...
$url = Request::path();
    $exp = explode ('/',$url);
    if ($exp[0]=='pesticides-list') {
        $exp[1] = '';
    } else if ($exp[0]=='pesticides-filter') {
        //$exp[0] = '';
        ...
        <div class="container-fluid p-0">
            <div class="product-list pt-5">
                <div class="d-flex align-items-center justify-content-center">
                    ...
                    <a href="#">
                        <h2><?php if (session()->has('bn')) {echo $lang['bn']['PESTICIDES'];}
                ...
                <!-- <div class="tr-sl-menu">
                    @if (session()->has('KVMobile')==1)
                        <a href="{{route('pesticide.post')}}">SELL</a>
                    @else
        ...
        <div class="container-md">
            <div class="row p-0 p-md-3">
                <div class="col-md-3 bg-white p-2 filter-block d-none">
                    ...
                    <form id="pesticides-filter" method="POST" action="{{route('pesticides.filter')}}">
                        @csrf
                        <div class="accordion" id="accordionExample">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                                    ...
                                    <div class="accordion-body">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="pesticide" name="category[]" id="trac-sell" <?php if ($exp[0]=='pesticides-list' || $exp[0]=='pesticides-filter') {echo 'checked';} ?>
                                            <?php if (session()->has('category')) { if (in_array('pesticide', session()->get('category'))) {echo 'checked';} }?>>
                            ...
                            <div class="accordion-item d-none">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                                    ...
                                    <div class="accordion-body">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="sell" name="type[]" id="trac-sell" <?php if ($exp[0]=='pesticides-list' || $exp[0]=='pesticides-filter') {echo 'checked';} ?>
                            ...
                            <div class="accordion-item d-none">
                                ...
                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                    ...
                                    <div class="accordion-body">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="new" name="condition[]" id="trac-new" <?php if ($exp[0]=='pesticides-list' || $exp[0]=='pesticides-filter') {echo 'checked';}  ?>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <?php 
                                            $val->state_name;
                                            if($exp[0]=='pesticides-list' || $exp[0]=='pesticides-filter'){
                                                $stateDataCount =  DB::table('pesticidesView')->where('state_id',$val->id)->whereIn('status',[1,4])->count();
                                            }
                                            if($stateDataCount  >= 1){ 
                                        ?>
                                        <div class="form-check">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                                    ...
                                    <div class="accordion-body" id="district_id">
                                        ...
                                        <?php 
                                            if($exp[0]=='pesticides-list' || $exp[0]=='pesticides-filter'){
                                                $districtDataCount =  DB::table('pesticidesView')->where('state_id',$val1->state_id)->where('district_id',$val1->id)->whereIn('status',[1,4])->count();
                                            }
                                        ...
                                        <div class="d-flex border">
                                            <div class="wrapper">
                                                ...
                                                <div class="range-input pb-4">
                                                    <input type="range" class="range-min" min="100" max="100000" value="100"
                                                        step="100" >
                                                    <input type="range" class="range-max" min="100" max="100000" value="10000"
                                                        step="100" >
                                                </div>
                                            </div>
                ...
                <div class="col-md-12 p-0 px-md-3">
                    <div class="container-fluid bg-white">
                        ...
                        <div class="sorting p-3">
                            ...
                            <a href="{{url('pesticides-filter/plh')}}" class="<?php if ($exp[1]=='plh') {echo 'active-filter';} else {echo '';} ?>">Price- Low to High</a>
                            <a href="{{url('pesticides-filter/phl')}}" class="<?php if ($exp[1]=='phl') {echo 'active-filter';} else {echo '';} ?>">Price- High to Low</a>
                            <a href="{{url('pesticides-filter/nf')}}" class="<?php if ($exp[1]=='nf') {echo 'active-filter';} else {echo '';} ?>">Newest First</a>
                        </div>
                                ...
                                <div class="col-6 col-md-3 p-0">
                                    <div class="tractor-list m-0">
                                        ...
                                        <div class="tractor-img-box">
                                            ...
                                            <a href="{{ url('pesticides/'.$val['id']) }}"><img src="{{$val['image1']}}" alt=""
                                ...
                                <div class="col-6 col-md-3 p-0">
                                    <div class="tractor-list m-0">
                                        ...
                                        <div class="tractor-img-box">
                                            ...
                                            <a href="{{ url('pesticides/'.$val1->id) }}">
                                                <!-- <img src="<?= env('APP_URL')."storage/pesticides/$val1->image1"; ?>" alt=""
                                                    class="p-3 tractor-img"> -->
                                                <img src="{{asset('storage/pesticides/'.$val1->image1)}}" alt="" class="p-3 tractor-img">
