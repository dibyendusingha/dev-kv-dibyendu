...
$url = Request::path();
    $exp = explode ('/',$url);
    if ($exp[0]=='fertilizer-list') {
        $exp[1] = '';
    } else if ($exp[0]=='fertilizer-filter') {
        //$exp[0] = '';
        ...
        <div class="container-fluid p-0">
            <div class="product-list pt-5">
                <div class="d-flex align-items-center justify-content-center">
                    ...
                    <a href="#">
                        <h2><?php if (session()->has('bn')) {echo $lang['bn']['FERTILIZERS'];}
                ...
                <!-- <div class="tr-sl-menu">
                    @if (session()->has('KVMobile')==1)
                        <a href="{{route('fertilizer.post')}}">SELL</a>
                    @else
        ...
        <div class="container-md">
            <div class="row p-0 p-md-3">
                <div class="col-md-3 bg-white p-2 filter-block d-none">
                    ...
                    <form id="fertilizer-filter" method="POST" action="{{route('fertilizer.filter')}}">
                        @csrf
                        <div class="accordion" id="accordionExample">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                                    ...
                                    <div class="accordion-body">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="fertilizer" name="category[]" id="trac-sell" <?php if ($exp[0]=='fertilizer-list' || $exp[0]=='fertilizer-filter') {echo 'checked';} ?>
                                            <?php if (session()->has('category')) { if (in_array('fertilizer', session()->get('category'))) {echo 'checked';} }?>>
                            ...
                            <div class="accordion-item d-none">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                                    ...
                                    <div class="accordion-body">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="sell" name="type[]" id="trac-sell" <?php if ($exp[0]=='fertilizer-list' || $exp[0]=='fertilizer-filter') {echo 'checked';} ?>
                            ...
                            <div class="accordion-item d-none">
                                ...
                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                    ...
                                    <div class="accordion-body">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="new" name="condition[]" id="trac-new" <?php if ($exp[0]=='fertilizer-list' || $exp[0]=='fertilizer-filter' ) {echo 'checked';}  ?>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <?php 
                                            if($exp[0]=='fertilizer-list' || $exp[0]=='fertilizer-filter'){
                                                $stateDataCount =  DB::table('fertilizerView')->where('state_id',$val->id)->whereIn('status',[1,4])->count();
                                            }
                                            if($stateDataCount  >= 1){ 
                                        ?>
                                        <div class="form-check">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                                    ...
                                    <?php 
                                        if($exp[0]=='fertilizer-list' || $exp[0]=='fertilizer-filter'){
                                            $districtDataCount =  DB::table('fertilizerView')->where('state_id',$val1->state_id)->where('district_id',$val1->id)->whereIn('status',[1,4])->count();
                                        }
                                        if($districtDataCount >= 1){ 
                                    ?>
                                    <div class="form-check">
                                        <input class="form-check-input state_prod_list" type="checkbox" name="district[]" id="trac-sell" value="{{$val1->id}}" <?php if($district==$val1->id) {echo 'checked';}?>
                                            ...
                                            <div class="wrapper">
                                                ...
                                                <div class="price-input">
                                                    <div class="field d-md-flex flex-column">
                                                        <span>Min</span>
                                                        <input type="number" class="input-min" value="<?php if (session()->has('min_price')) { echo session()->get('min_price'); } else {echo 10;}?>" name="min_price" >
                                                    </div>
                                                    <div class="separator pt-4">-</div>
                                                    <div class="field d-md-flex flex-column">
                                                        <span>Max</span>
                                                        <input type="number" class="input-max" value="<?php if (session()->has('max_price')) { echo session()->get('max_price'); } else {echo 10000;}?>" name="max_price" >
                                                    </div>
                                                </div>
                                                <div class="slider">
                                                ...
                                                <div class="range-input pb-4">
                                                    <input type="range" class="range-min" min="0" max="500000" value="1000"
                                                        step="100" >
                                                    <input type="range" class="range-max" min="0" max="500000" value="1000"
                                                        step="100" >
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="col-md-12 p-0 px-md-3">
                    <div class="container-fluid bg-white">
                        ...
                        <div class="sorting p-3">
                            ...
                            <a href="{{url('fertilizer-filter/plh')}}" class="<?php if ($exp[1]=='plh') {echo 'active-filter';} else {echo '';} ?>">Price- Low to High</a>
                            <a href="{{url('fertilizer-filter/phl')}}" class="<?php if ($exp[1]=='phl') {echo 'active-filter';} else {echo '';} ?>">Price- High to Low</a>
                            <a href="{{url('fertilizer-filter/nf')}}" class="<?php if ($exp[1]=='nf') {echo 'active-filter';} else {echo '';} ?>">Newest First</a>
                        </div>
                            ...
                            <div class="col-6 col-md-3 p-0">
                                <div class="tractor-list m-0">
                                    ...
                                    <div class="tractor-img-box">
                                        ...
                                        <a href="{{ url('fertilizers/'.$val['id']) }}"><img src="{{$val['image1']}}" alt=""
                                ...
                                <div class="col-6 col-md-3 p-0">
                                    <div class="tractor-list m-0">
                                        ...
                                        <div class="tractor-img-box">
                                            ...
                                            <a href="{{ url('fertilizers/'.$val1->id) }}">
                                                <!-- <img src="<?= env('APP_URL')."storage/fertilizers/$val1->image1"; ?>" alt=""
                                                    class="p-3 tractor-img"> -->
                                                <img src="{{asset('storage/fertilizers/'.$val1->image1)}}" alt="" class="p-3 tractor-img">
                        ...
                        <?php if(!empty($fer_buy)){?>
                            <div class="row">
                                <?php foreach ($fer_buy as $val1) { ?>
                                <div class="col-6 col-md-3 p-0">
                                    <div class="tractor-list m-0">
