...
?>
    ...
    <section class="post-category bg-t" id="pc">
        <div class="container glass-t">
            ...
            <img src="./assets/images/implements-head.jpeg" alt="" width="200">
                <h3><?php if (session()->has('bn')) {echo $lang['bn']['IMPLEMENTS'];} 
...
<div class="form-content container">
    <form action="{{url('implement-posting')}}" method="post" class="form" enctype="multipart/form-data">
        @csrf
        <!-- Progress bar -->
                ...
                <div class="row">
                    <div class="col-6 ">
                        <label for="" class="w-100 h-100"> 
                            <div class="sell new option-post">
                                        <img src="./assets/images/imple-new.png" alt="" class="img-fluid">
                                        <p class="fs-3 fw-bold"><?php if (session()->has('bn')) {echo $lang['bn']['NEW IMPLEMENTS'];} 
                    ...
                    <div class="col-6 ">
                       ...
                       <div class="sell old option-post">
                                        <img src="./assets/images/imple-USE.png" alt="" class="img-fluid pb-3">
                                        <p class="fs-3 fw-bold"><?php if (session()->has('bn')) {echo $lang['bn']['USED IMPLEMENTS'];} 
            ...
            <div class="container upl">
                <div class="row">
                    ...
                    <div class="img-trac-box fw-bold">
                                        ...
                                        <img id="preview-i1" class="img-fluid" src="./assets/images/front-im.png"
                                            alt="">
                                        <!-- <input type="file" id="front-img" name="filename" class="d-none"
                                            accept="image/*" capture="camera"> -->
                                        <div class="camera-option d-none block-i1">
                                            <div class="bg-white p-5">
                                                <div class="camera-click">
                                                    <label for="front-img-i1"><i class="fa-solid fa-camera"></i>
                                                        Capture</label>
                                                    <input type="file" id="front-img-i1" name="front_image1"
                                                        accept="image/*" capture="camera" class="d-none">
                                                </div>
                                                <div class="gallery-click">
                                                    <label for="front-img-i2"><i class="fa-regular fa-image"></i> Choose
                                                        from Gallery</label>
                                                    <input type="file" id="front-img-i2" name="front_image2" class="d-none">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="img-trac-box fw-bold">
                                        ...
                                        <img id="preview-i2" class="img-fluid" src="./assets/images/back-im.png" alt="">
                                        <!-- <input type="file" id="back-img" name="filename" class="d-none" accept="image/*"
                                            capture="camera"> -->

                                        <div class="camera-option d-none block-i2">
                                            <div class="bg-white p-5">
                                                <div class="camera-click">
                                                    <label for="back-img-i1"><i class="fa-solid fa-camera"></i>
                                                        Capture</label>
                                                    <input type="file" id="back-img-i1" name="back_image1" accept="image/*"
                                                        capture="camera" class="d-none">
                                                </div>
                                                <div class="gallery-click">
                                                    <label for="back-img-i2"><i class="fa-regular fa-image"></i> Choose
                                                        from Gallery</label>
                                                    <input type="file" id="back-img-i2" name="back_image2" class="d-none">
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="img-trac-box">
                                        ...
                                        <img id="preview-i3" class="img-fluid" src="./assets/images/left-im.png" alt="">
                                        <!-- <input type="file" id="left-img" name="filename" class="d-none" accept="image/*"
                                            capture="camera"> -->
                                        <div class="camera-option d-none block-i3">
                                            <div class="bg-white p-5">
                                                <div class="camera-click">
                                                    <label for="left-img-i1"><i class="fa-solid fa-camera"></i>
                                                        Capture</label>
                                                    <input type="file" id="left-img-i1" name="left_image1" accept="image/*"
                                                        capture="camera" class="d-none">
                                                </div>
                                                <div class="gallery-click">
                                                    <label for="left-img-i2"><i class="fa-regular fa-image"></i> Choose
                                                        from Gallery</label>
                                                    <input type="file" id="left-img-i2" name="left_image2" class="d-none">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="img-trac-box fw-bold">
                                        ...
                                        <img id="preview-i4" class="img-fluid" src="./assets/images/right-im.png"
                                            alt="">
                                        <!-- <input type="file" id="right-img" name="filename" class="d-none"
                                            accept="image/*" capture="camera"> -->

                                        <div class="camera-option d-none block-i4">
                                            <div class="bg-white p-5">
                                                <div class="camera-click">
                                                    <label for="right-img-i1"><i class="fa-solid fa-camera"></i>
                                                        Capture</label>
                                                    <input type="file" id="right-img-i1" name="right_image1"
                                                        accept="image/*" capture="camera" class="d-none">
                                                </div>
                                                <div class="gallery-click">
                                                    <label for="right-img-i2"><i class="fa-regular fa-image"></i> Choose
                                                        from Gallery</label>
                                                    <input type="file" id="right-img-i2" name="right_image2" class="d-none">
                                                </div>
                                            </div>
                                        </div>
