    ...
    <!-- SELL RENT SECTION START -->
     <section class="post-category bg-t" id="pc">
        <div class="container glass-t">
            ...
            <img src="./assets/images/hh.png" alt="" width="200">
                <h3><?php if (session()->has('bn')) {echo $lang['bn']['HARVESTER'];} 
...
<div class="form-content container">
    <form action="{{url('harvester-posting')}}" method="post" class="form" enctype="multipart/form-data">
    @csrf
        <!-- Progress bar -->
        ...
        <div class="form-step animate__animated animate__zoomIn">
            ...
            <div class="container tractor-option nu-trac">
                <div class="row">
                    <div class="col-6 ">
                        <label for="" class="w-100 h-100">
                            <div class="sell new option-post">
                                        <img src="./assets/images/hv-new-p.png" alt="" class="img-fluid">
                                        <p class="fs-3 fw-bold"><?php if (session()->has('bn')) {echo $lang['bn']['NEW HARVESTER'];} 
                    ...
                    <div class="col-6 ">
                       ...
                       <div class="sell old option-post">
                                        <img src="./assets/images/hv-old-p.png" alt="" class="img-fluid pb-3">
                                        <p class="fs-3 fw-bold"><?php if (session()->has('bn')) {echo $lang['bn']['USED HARVESTER'];} 
        ...
        <div class="form-step animate__animated animate__zoomIn enDetails">
            ...
            <div class="container tractor-brand" id="msform1">
                ...
                <select class="form-select" name="yop" >
                ...
                <br>
                            <select class="form-select mb-2" name="crop_type">
                                <option value="Multi-Crop">Multi-Crop</option>
                            ...
                            <select class="form-select mb-2" name="cutting_with">
                            ...
                            <select class="form-select mb-2" name="power_source">
                                <option value="Self">Self</option>
                                <option value="Tractor Mounted">Tractor Mounted</option>
                            </select>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="img-trac-box fw-bold">
                                        ...
                                        <img id="preview-h1" class="img-fluid" src="./assets/images/hv4.png" alt="">
                                        <!-- <input type="file" id="front-img" name="filename" class="d-none"
                                            accept="image/*" capture="camera"> -->
                                        <div class="camera-option d-none block-h1">
                                            <div class="bg-white p-5">
                                                <div class="camera-click">
                                                    <label for="front-img-h1"><i class="fa-solid fa-camera"></i>
                                                        Capture</label>
                                                    <input type="file" id="front-img-h1" name="front_image1"
                                                        accept="image/*" capture="camera" class="d-none">
                                                </div>
                                                <div class="gallery-click">
                                                    <label for="front-img-h2"><i class="fa-regular fa-image"></i> Choose
                                                        from Gallery</label>
                                                    <input type="file" id="front-img-h2" name="front_image2" class="d-none">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="img-trac-box fw-bold">
                                        ...
                                        <img id="preview-h2" class="img-fluid" src="./assets/images/hv1.png" alt="">
                                        <!-- <input type="file" id="back-img" name="filename" class="d-none" accept="image/*"
                                            capture="camera"> -->

                                        <div class="camera-option d-none block-h2">
                                            <div class="bg-white p-5">
                                                <div class="camera-click">
                                                    <label for="back-img-h1"><i class="fa-solid fa-camera"></i>
                                                        Capture</label>
                                                    <input type="file" id="back-img-h1" name="back_image1" accept="image/*"
                                                        capture="camera" class="d-none">
                                                </div>
                                                <div class="gallery-click">
                                                    <label for="back-img-h2"><i class="fa-regular fa-image"></i> Choose
                                                        from Gallery</label>
                                                    <input type="file" id="back-img-h2" name="back_image2" class="d-none">
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="img-trac-box">
                                        ...
                                        <img id="preview-h3" class="img-fluid" src="./assets/images/hv2.png" alt="">
                                        <!-- <input type="file" id="left-img" name="filename" class="d-none" accept="image/*"
                                            capture="camera"> -->
                                        <div class="camera-option d-none block-h3">
                                            <div class="bg-white p-5">
                                                <div class="camera-click">
                                                    <label for="left-img-h1"><i class="fa-solid fa-camera"></i>
                                                        Capture</label>
                                                    <input type="file" id="left-img-h1" name="left_image1" accept="image/*"
                                                        capture="camera" class="d-none">
                                                </div>
                                                <div class="gallery-click">
                                                    <label for="left-img-h2"><i class="fa-regular fa-image"></i> Choose
                                                        from Gallery</label>
                                                    <input type="file" id="left-img-h2" name="left_image2" class="d-none">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="img-trac-box fw-bold">
                                        ...
                                        <img id="preview-h4" class="img-fluid" src="./assets/images/hv3.png" alt="">
                                        <!-- <input type="file" id="right-img" name="filename" class="d-none"
                                            accept="image/*" capture="camera"> -->

                                        <div class="camera-option d-none block-h4">
                                            <div class="bg-white p-5">
                                                <div class="camera-click">
                                                    <label for="right-img-h1"><i class="fa-solid fa-camera"></i>
                                                        Capture</label>
                                                    <input type="file" id="right-img-h1" name="right_image1"
                                                        accept="image/*" capture="camera" class="d-none">
                                                </div>
                                                <div class="gallery-click">
                                                    <label for="right-img-h2"><i class="fa-regular fa-image"></i> Choose
                                                        from Gallery</label>
                                                    <input type="file" id="right-img-h2" name="right_image2" class="d-none">
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="img-trac-box fw-bold">
                                        ...
                                        <img class="img-fluid" id="preview-h5" src="./assets/images/meter.png" alt="">
                                        <!-- <input type="file" id="meter-img" name="filename" class="d-none"
                                            accept="image/*" capture="camera"> -->
                                        <div class="camera-option d-none block-h5">
                                            <div class="bg-white p-5">
                                                <div class="camera-click">
                                                    <label for="meter-img-h1"><i class="fa-solid fa-camera"></i>
                                                        Capture</label>
                                                    <input type="file" id="meter-img-h1" name="meter_image1"
                                                        accept="image/*" capture="camera" class="d-none">
                                                </div>
                                                <div class="gallery-click">
                                                    <label for="meter-img-h2"><i class="fa-regular fa-image"></i> Choose
                                                        from Gallery</label>
                                                    <input type="file" id="meter-img-h2" name="meter_image2" class="d-none">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-6">
                                    <div class="img-trac-box fw-bold">
                                        ...
                                        <img class="img-fluid" id="preview-h6" src="./assets/images/tyre-post.png"
                                            alt="">
                                        <!-- <input type="file" id="tyre-img" name="filename" class="d-none" accept="image/*"
                                            capture="camera"> -->
                                        <div class="camera-option d-none block-h6">
                                            <div class="bg-white p-5">
                                                <div class="camera-click">
                                                    <label for="tyre-img-h1"><i class="fa-solid fa-camera"></i>
                                                        Capture</label>
                                                    <input type="file" id="tyre-img-h1" name="tyre_image1" accept="image/*"
                                                        capture="camera" class="d-none">
                                                </div>
                                                <div class="gallery-click">
                                                    <label for="tyre-img-h2"><i class="fa-regular fa-image"></i> Choose
                                                        from Gallery</label>
                                                    <input type="file" id="tyre-img-h2" name="tyre_image2" class="d-none">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <!--<script>
        $(document).ready(function () {
            ...
            if (userChoice === "sell") {
                ...
                $('input[value="sell-trac"]').prop("checked", true);
                ...
                $('input[value="rent-trac"]').prop("checked", true);
