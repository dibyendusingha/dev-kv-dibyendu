...
<?php 
    ...
    $gv = DB::table('goods_vehicle')->where('id',$gv_id)->first();
    $user_id = $gv->user_id;
            ...
            <div class="row">
                    ...
                    <div class="d-flex">
                        <div class="product-img-list py-3 px-2">
                            <section id="product-diff-img">
                                ...
                                <?php if ($data['front_image']!='') { ?>
                                <div class="item">
                                    <!-- <img src="{{ $data['front_image']}}" alt="" class="small-img"> -->
                                    <img src="{{asset($data['front_image'])}}" alt="" class="small-img">
                                </div>
                                <?php } ?>
                                <?php if ($data['back_image']!='') { ?>
                                <div class="item">
                                    <!-- <img src="{{ $data['back_image']}}" alt="" class="small-img"> -->
                                    <img src="{{asset($data['back_image'])}}" alt="" class="small-img">
                                </div>
                                <?php } ?>
                                <?php if ($data['left_image']!='') { ?>
                                <div class="item">
                                    <!-- <img src="{{ $data['left_image']}}" alt="" class="small-img"> -->
                                    <img src="{{asset($data['left_image'])}}" alt="" class="small-img">
                                </div>
                                <?php } ?>
                                <?php if ($data['right_image']!='') { ?>
                                <div class="item">
                                    <!-- <img src="{{ $data['right_image']}}" alt="" class="small-img"> -->
                                    <img src="{{asset($data['right_image'])}}" alt="" class="small-img">
                                </div>
                                <?php } ?>
                                <?php if ($data['meter_image']!='') { ?>
                                <div class="item">
                                    <!-- <img src="{{$data['meter_image']}}" alt="" class="small-img"> -->
                                    <img src="{{asset($data['meter_image'])}}" alt="" class="small-img">
                                </div>
                                <?php } ?>
                                <?php if ($data['tyre_image']!='') { ?>
                                <div class="item">
                                    <!-- <img src="{{$data['tyre_image']}}" alt="" class="small-img"> -->
                                    <img src="{{asset($data['tyre_image'])}}" alt="" class="small-img">
                                </div>
                                <?php } ?>
                        ...
                        <div class="product-modal mb-4" style="position:relative;">
                            ...
                            <?php if ($data['status']==4) { ?>
                                ...
                                <img src="{{asset($data['front_image'])}}"  alt="" class="img-fluid" id="main-img-original" onclick="openLightbox()">
                            <?php }else{ ?>
                            <img src="{{asset('storage/sold/kv.png')}}" alt="sold" width="100" style="position: absolute; right: 0;object-fit: contain;width: 120px !important; bottom:40%;">
                            <!-- <img src="{{$data['front_image']}}" alt="" class="img-fluid" id="main-img-original" onclick="openLightbox()"> -->
                            <img src="{{asset($data['front_image'])}}"  alt="" class="img-fluid" id="main-img-original" onclick="openLightbox()">
                            <?php }?>
                        </div>
                    </div>
                ...
                <div class="col-lg-5 pt-4">
                    <div class="d-flex border rounded px-4 justify-content-around">
                        <div class="">
                            <h1 class="text-success">{{$data['brand_name']}} {{$data['model_name']}}</h1>
                            <div class="">
                                <div class="fs-4">
                            ...
                            <div class="price">
                                <p> <i class="fa-solid fa-indian-rupee-sign"></i> {{$data['price']}} <span style="font-size: 22px;"><?php if ($data['set']=='rent') { echo $data['rent_type'];}?></span></p>
                            </div>
                        </div>
                        <div>
                        ...
                        $wishcount = DB::table('wishlist')->where(['user_id'=>$user_id,'category_id'=>3,'item_id'=>$data['id']])->count();
                        ?>
                            <i class="fa-solid fa-heart <?php if ($wishcount>0) {echo 'active-fav';} ?>" id="add-fav"
                                onclick="addtofav('gv',{{$data['id']}})"></i>
                    ...
                    <div class="spec-row rounded" id="summarySpecs">
                        <h2>
                            <?php if (session()->has('bn')) {echo $lang['bn']['Specifications'];} 
                                                    ...
                                                    else { echo 'Specifications'; } 
                                                    ?></h2>
                        <table width="100%" class="table table-striped mt-5">
                            <tbody>
                                <tr>
                                    <th>RC Available</th>
                                    <td><span itemprop="itemCondition" class="wpcm-vehicle-data"><?php if($data['rc_available']=='true') {echo 'Yes';} else {echo 'No';} ?></span></td>
                                </tr>
                                <tr>
                                    <th>NOC Available</th>
                                    <td><span itemprop="mileageFromOdometer" class="wpcm-vehicle-data"><?php if($data['noc_available']=='true') {echo 'Yes';} else {echo 'No';} ?></span> </td>
                                </tr>
                                <tr>
                                    <th>Price Negotiable</th>
                                    <td><span itemprop="mileageFromOdometer" class="wpcm-vehicle-data"><?php if($data['is_negotiable']=='true') {echo 'Yes';} else {echo 'No';} ?></span> </td>
                                </tr>
                                
                                <tr>
                                    <th>Registration Number</th>
                                    <td><span itemprop="mileageFromOdometer" class="wpcm-vehicle-data">{{$data['registration_no']}}</span> </td>
                                </tr>
                                <tr>
                                    <th>Year Of Purchase</th>
                                    <td><span itemprop="mileageFromOdometer" class="wpcm-vehicle-data">{{$data['year_of_purchase']}}</span> </td>
                                </tr>
    ...
    <div class="container-fluid p-0 bg-white my-5">
        <div class="rp-header row m-0">
            <div class="col-md-5 h1">
                <h1>
                    <?php if (session()->has('bn')) {echo $lang['bn']['RELATED ITEMS'];} 
            ...
            <div class="item">
                <div class="rp-list">
                    ...
                    <div class="rp-img-box">
                        <a href="{{ url('good-vahicle/'.$val_rel['id']) }}">
                            ...
                            <!-- <img src="{{$val_rel['front_image']}}" alt="" class="p-3 tractor-img"> -->
                            <img src="{{asset($val_rel['front_image'])}}" alt="" class="p-3 tractor-img">
                            
                            </a>
                        <div class="shadow-line">

                        </div>
                        <p class="fw-bolder">{{$val_rel['brand_name']}} {{$val_rel['model_name']}}</p>
                        ...
                        <div class="spec d-flex justify-content-around align-items-center pt-3">
                            ...
                            <p><i class="fa-solid fa-indian-rupee-sign"></i> {{$val_rel['price']}}
                            <?php if($val_rel['set']=='rent') {
                                if ($val_rel['rent_type']=='Per Hour') {
                                    echo '/hr';
                                } else if ($val_rel['rent_type']=='Per Month') {
                                    echo '/m';
                                } else if ($val_rel['rent_type']=='Per Day') {
                                    echo '/d';
                                }
                            } ?>
                            </p>
