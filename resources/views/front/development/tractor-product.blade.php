...
<?php 
    ...
    $tractor = DB::table('tractor')->where('id',$tractor_id)->first();
    $user_id = $tractor->user_id;
            ...
            <div class="row">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="product-modal mb-4" style="position:relative;">
                            <?php if ($data['status']==4) { ?>
                                ...
                                <img src="{{asset('sold/kv.png')}}" alt="sold" width="100" style="position: absolute; right: 0;object-fit: contain;width: 120px !important; bottom:40%;">
                ...
                <div class="col-lg-5 pt-4">
                    <div class="d-flex border rounded px-4 justify-content-around">
                        ...
                        $wishcount = DB::table('wishlist')->where(['user_id'=>$user_id,'category_id'=>1,'item_id'=>$data['id']])->count();
                        ?>
                            <i class="fa-solid fa-heart <?php if ($wishcount>0) {echo 'active-fav';} ?>" id="add-fav"
                                onclick="addtofav('tractor',{{$data['id']}})"></i>
            ...
            <div class="row mt-2">
                <div class="col-md-7">
                    <div class="spec-row rounded" id="summarySpecs">
                        <h2><?php if (session()->has('bn')) {echo $lang['bn']['Specifications'];} 
                        ...
                        <table width="100%" class="table table-striped mt-5">
                            <tbody>
                                <tr>
                                    <th>RC Available</th>
                                    <td><span itemprop="itemCondition" class="wpcm-vehicle-data">
                                            <?php if($data['rc_available']=='true') {echo 'Yes';} else {echo 'No';} ?>
                                        </span></td>
                                </tr>
                                <tr>
                                    <th>NOC Available</th>
                                    <td><span itemprop="mileageFromOdometer" class="wpcm-vehicle-data">
                                            <?php if($data['noc_available']=='true') {echo 'Yes';} else {echo 'No';} ?>
                                        </span> </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><span itemprop="mileageFromOdometer"
                                            class="wpcm-vehicle-data">{{$data['registration_no']}}</span> </td>
                                </tr>
                                <tr>
                                    <th>Year Of Purchase</th>
                                    <td><span itemprop="mileageFromOdometer"
                                            class="wpcm-vehicle-data">{{$data['year_of_purchase']}}</span> </td>
                                </tr>
            ...
            <div class="item">
                <div class="rp-list">
                    ...
                    <div class="rp-img-box">
                        ...
                        <p class="fw-bolder">
                            <?php $string = $val_rel['brand_name'].' '.$val_rel['model_name']; ?>
                            {{Str::limit($string, 25, '...')}}
                        </p>
