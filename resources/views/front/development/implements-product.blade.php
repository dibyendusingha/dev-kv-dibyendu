...
<?php 
    ...
    $tractor = DB::table('implements')->where('id',$tractor_id)->first();
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="d-flex">
                        ...
                        <div class="product-modal mb-4" style="position:relative;">
                            ...
                            <img src="{{asset('public/storage/photo/sold_tag.png')}}" class="img-fluid" alt="" width="100" style="position: absolute;top: 0;object-fit:contain">
                            <?php } ?>
                ...
                <div class="col-lg-5 pt-4">
                    <div class="d-flex border rounded px-4 justify-content-around">
                        ...
                        $wishcount = DB::table('wishlist')->where(['user_id'=>$user_id,'category_id'=>5,'item_id'=>$data['id']])->count();
                        ?>
                            <i class="fa-solid fa-heart <?php if ($wishcount>0) {echo 'active-fav';} ?>" id="add-fav"
                                onclick="addtofav('implements',{{$data['id']}})"></i>
            ...
            <div class="item">
                <div class="rp-list">
                    ...
                    <div class="rp-img-box">
                        <a href="{{ url('implements/'.$val_rel['id']) }}">
