...
<?php 
    ...
    $tractor = DB::table('harvester')->where('id',$harvester_id)->first();
            ...
            <div class="row">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="product-modal mb-4" style="position:relative;">
                            ...
                            <?php if ($data['status']==4) { ?>
                                ...
                                <img src="{{asset($data['right_image'])}}" alt="" class="img-fluid" id="main-img-original"  onclick="openLightbox()">
                            <?php }else{ ?>
                                <img src="{{asset('storage/sold/kv.png')}}" alt="sold" width="100" style="position: absolute; right: 0;object-fit: contain;width: 120px !important; bottom:40%;">
                                <!-- <img src="{{$data['front_image']}}" alt="" class="img-fluid" id="main-img-original" onclick="openLightbox()"> -->
                                <img src="{{asset($data['right_image'])}}"  alt="" class="img-fluid" id="main-img-original"  onclick="openLightbox()">
                ...
                <div class="col-lg-5 pt-4">
                    <div class="d-flex border rounded px-4 justify-content-around">
                        ...
                        $wishcount = DB::table('wishlist')->where(['user_id'=>$user_id,'category_id'=>4,'item_id'=>$data['id']])->count();
                        ?>
                            <i class="fa-solid fa-heart <?php if ($wishcount>0) {echo 'active-fav';} ?>" id="add-fav"
                                onclick="addtofav('harvester',{{$data['id']}})"></i>
                    ...
                    <div class="seller-datails border rounded p-3 mt-3">
                        ...
                        <div class="no-show px-5">
                            ...
                            <p class="text-center px-5 py-2 rounded bg-light text-dark border border-2 border-dark">
                                XXXXXXXXXX</p>
                            <button type="button"
                                class="w-100 px-5 py-2 border-0 rounded  bg-success fw-bold text-white myBtn"><?php if (session()->has('bn')) {echo $lang['bn']['SHOW NUMBER'];} 
            ...
            <div class="item">
                <div class="rp-list">
                    ...
                    <div class="rp-img-box">
                        <a href="{{ url('harvester/'.$val_rel['id']) }}">
