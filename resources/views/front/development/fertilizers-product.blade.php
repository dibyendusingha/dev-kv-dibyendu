...
<?php 
    ...
    $fertilizer = DB::table('fertilizers')->where('id',$fertilizer_id)->first();
    $user_id = $fertilizer->user_id;
                ...
                <div class="col-lg-5 pt-4">
                    <div class="d-flex border rounded px-4 justify-content-around">
                        ...
                        <div>
                            ...
                            $wishcount = DB::table('wishlist')->where(['user_id'=>$user_id,'category_id'=>9,'item_id'=>$data['id']])->count();
                            ?>
                            <i class="fa-solid fa-heart" id="add-fav" <?php if ($wishcount>0) {echo 'active-fav';}?>
                                onclick="addtofav('fertilizer',{{$data['id']}})"></i>
                    ...
                    <div class="seller-datails border rounded p-3 mt-3">
                        ...
                        <!-- <div class="no-show">
                            <p>XXXXXXXXXX</p>
                            <button type="button">SHOW NUMBER</button>
                        </div> -->
            ...
            <div class="item">
                <div class="rp-list">
                    ...
                    <div class="rp-img-box">
                        <a href="{{ url('fertilizers/'.$val_rel['id']) }}">
