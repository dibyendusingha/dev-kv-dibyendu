            ...
            <div class="col-lg-5">
                <div class="card card-body mb-4">
                    <article class="icontext">
                        ...
                        <div class="text">
                            <h6 class="mb-1 card-title">PENDING CROP POST</h6>
                            <span>{{$pending_crops}}</span>
                        </div>
                    </article>
                </div>
            </div>
            ...
            <div class="col-lg-5">
                <div class="card card-body mb-4">
                    <article class="icontext">
                        <span class="icon icon-sm rounded-circle bg-primary-light"><i class="icon material-icons md-person fs-2 ps-2 text-success"></i></span>
                        <div class="text">
                            <h6 class="mb-1 card-title">ACTIVE CROP POST</h6>
                            <span>{{$active_crops}}</span>
                        </div>
                    </article>
                </div>
            </div>
            ...
            <div class="col-lg-5">
                <div class="card card-body mb-4">
                    <article class="icontext">
                        ...
                        <div class="text">
                            <h6 class="mb-1 card-title">INACTIVE CROPS POST</h6>
                            <span>{{$inactive_crops}}</span>
                        </div>
                    </article>
                </div>
            </div>
            ...
            <div class="col-lg-5">
                <div class="card card-body mb-4">
                    <article class="icontext">
                        <span class="icon icon-sm rounded-circle bg-warning-light"><i class="icon material-icons md-person fs-2 ps-2 text-danger"></i></span>
                        <div class="text">
                            <h6 class="mb-1 card-title">REJECTED CROPS POST</h6>
                            <span>{{$reject_crops}}</span>
                        </div>
                    </article>
                </div>
            </div>
                    ...
                    <table class="datatable-init-export nk-tb-list nk-tb-ulist table table-hover" data-auto-responsive="false" data-export-title="Export">
                        ...
                        <tbody id="table_tbody">
                            ...
                            <tr>
                                ...
                                <td>{{$crop->name}}</td>
                                <td>
                                    <span class="badge rounded-pill alert-<?php if ($crop->user_type_id == 2) {
                                                                                echo 'success';
