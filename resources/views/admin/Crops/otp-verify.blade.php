<?php
    $crops_subscribed_all = json_encode($crops_subscribed);
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <script>
        $(document).ready(function() {
            $('#crop-form').submit(function(e) {
                ...
                var cropsSubscribedData = [];
                cropsSubscribedData = '<?php echo $crops_subscribed_all; ?>';
               ...
               // console.log(cropsData);
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        third:third,
                        forth:forth,
                        cropsSubscribedData: cropsSubscribedData,
                        _token: "{{ csrf_token() }}"
                    },
                    success: function(response) {
                        ...
                        if(response.response == "failed"){
                            ...
                            console.log(response);
                            window.location.href= base_url+'crops-post-list';
                        }
                    }
                });
            });
    ...
    <script>
        function otpSent() {
            ...
            var crops_subscribed_all = [];
            crops_subscribed_all     = '<?php echo $crops_subscribed_all; ?>';

            $.ajax({
                type: 'POST',
                url: "{{route('resend.otp')}}",
                data:{
                    crops_subscribed_all: crops_subscribed_all,
                    _token: "{{ csrf_token() }}"
                },
                success: function(response) {
                    console.log(response);
