                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <form method="post" action="{{url('krishi-harvester-brand-update')}}" enctype="multipart/form-data">
                                 @csrf
                                                ...
                                                <td class="text-end">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="{{ url('krishi-harvester-brand-edit/'.$val->id) }}">Edit info</a>
                                                            <a class="dropdown-item text-danger" href="{{ url('krishi-harvester-brand-delete/'.$val->id) }}">Delete</a>
                                                        </div>
                                                    </div>
                                                    <!-- dropdown //end -->
                                                </td>
