                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <form method="post" action="{{url('krishi-update-seasons',$season_edit->id)}}" enctype="multipart/form-data">
                                 @csrf
                                 <div class="mb-4">
                                        <label for="product_name" class="form-label">Season Name</label>
                                        <input type="text" placeholder="Type here" class="form-control" id="brand_name" name="season_name" value="{{$season_edit->name}}" required/>
                                        @error('brand_name')
                                    ...
                                    <div class="mb-4">
    	                                ...
    	                                <img src="{{asset('storage/crop_calender/'.$season_edit->image) }}" alt="" />
