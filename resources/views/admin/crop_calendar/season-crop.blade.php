                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <form method="post" action="{{url('krishi-add-seasons-crop')}}" enctype="multipart/form-data">
                                 @csrf
                                 <div class="mb-4">
                                        ...
                                        <select class="form-control" id="brand_name" name="season_id">
                                          <option value="" selected>-- select --</option>
                                            @foreach($season_all_data as $data)
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" placeholder="Type here" class="form-control" id="brand_name" name="cropName" />
                                        @error('brand_name')
                                        <div class="" style="color:red"></div>
                                        @enderror
                                    </div>
                                                ...
                                                <td class="text-end">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu ">
                                                            <a class="dropdown-item" href="krishi-edit-seasons-crop/{{$data->id}}">Edit info</a>
                                                            <a class="dropdown-item" href="">Deactivate</a>
                                                            <a class="dropdown-item text-danger" href="krishi-delete-seasons-crop/{{ $data->id }}">Delete</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
