                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <form method="post" action="{{url('krishi-tractor-brand-update')}}" enctype="multipart/form-data">
                                 @csrf
                                                ...
                                                <td class="text-end">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="{{ url('krishi-tractor-brand-edit/'.$val->id) }}">Edit info</a>
                                                            <a class="dropdown-item text-danger" href="{{ url('krishi-tractor-brand-delete/'.$val->id) }}">Delete</a>
                                                        </div>
                                                    </div>
                                                    <!-- dropdown //end -->
                                                </td>
