                    			...
                    			<div class="table-responsive">
                                        ...
                                        <thead>
                                            <tr class="nk-tb-item nk-tb-head">
                                                ...
                                                <th class="nk-tb-col tb-col-mb">Brand</th>
                                                <th class="nk-tb-col tb-col-mb">Model</th>
                                                <th class="nk-tb-col tb-col-mb">Type</th>
                                                <th class="nk-tb-col tb-col-mb">Name</th>
                                        ...
                                        <tbody id="table_tbody">
                                            <?php
                                            $tractor_arr = DB::table('tractor')->orderBy('id','desc')->paginate(50);
                                            foreach ($tractor_arr as $val) {
