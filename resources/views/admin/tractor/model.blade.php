                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            @endif
                            <div class="col-md-3">
                                <form method="post" action="{{url('krishi-tractor-model-submit')}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-4">
                                        <label for="product_name" class="form-label">Brand Name</label>
                                        <select class="form-select" name="brand_id">
                                            <?php
                                            $brand_arr = DB::table('brand')->where(['category_id'=>1])->get();
                                            print_r($brand_arr);
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php 
                                                $c_count = DB::table('brand')->where(['id'=>$val_m->brand_id])->count();
                                                if ($c_count>0) {
                                                ...
                                                <td class="text-end">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="{{url('krishi-tractor-model-edit/'.$val_m->id)}}">Edit info</a>
                                                            <a class="dropdown-item text-danger" href="{{url('krishi-tractor-model-delete/'.$val_m->id)}}">Delete</a>
                                                        </div>
                                                    </div>
                                                    <!-- dropdown //end -->
                                                </td>
