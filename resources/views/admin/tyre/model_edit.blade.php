                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            @endif
                            <div class="col-md-3">
                                <form method="post" action="{{url('krishi-tyre-model-update')}}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select" name="brand_id">
                                            <?php
                                            $brand_arr = DB::table('brand')->where(['category_id'=>7])->get();
                                            print_r($brand_arr);
                                                ...
                                                <td class="text-end">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="{{url('krishi-tyre-model-edit/'.$val_m->id)}}">Edit info</a>
                                                            <a class="dropdown-item text-danger" href="{{url('krishi-tyre-model-delete/'.$val_m->id)}}">Delete</a>
                                                        </div>
                                                    </div>
                                                    <!-- dropdown //end -->
                                                </td>
