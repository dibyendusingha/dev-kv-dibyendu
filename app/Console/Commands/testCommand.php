...
class testCommand extends Command
{
    ...
    public function handle(): void
    {
        ...
        DB::table('user')->select('id','firebase_token')->whereIn('mobile',[9123096629,8804911492])->where('status',1)->where('lamguage',1)->chunkById(1, function ($chunk) use (&$id) {
        ...
        $english_content = DB::table('push_notification')->orderBy('id','desc')->where(['language_id'=>1])->first();
            ...
            $sound = 'https://krishivikas.com/storage/sound/notification_sound_kv.wav';
            $fields = array (
