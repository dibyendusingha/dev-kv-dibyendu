...
class BengaliCorn extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'bengali:corn';
    ...
    public function handle(): void
    {
        ...
        //AdminEnd::push_notification_send();
            ...
            $english_content = DB::table('push_notification')->orderBy('id','desc')->where(['language_id'=>3])->first();
            
        DB::table('user')->select('id','firebase_token')->whereIn('mobile',[9123096629,8116597309,7980711876,7063166412])->where('status',1)->where('lamguage',3)->chunkById(1, function ($chunk) use (&$id) {
